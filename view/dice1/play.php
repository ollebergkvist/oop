...
<body>
    <div class="container" style="margin-top:4em;">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-4">Dice 100 (Controller)</h1>
